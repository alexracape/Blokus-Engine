...
//                 let player = self.game.current_player().expect("No current player");
//                 let mut new_state = (*self).clone();
//                 let piece = self.game.get_piece(player, p, v);

//                 // Check if move is valid
//                 if !new_state.game.is_valid_move(player, &piece, o) {
...
//                         new_state.game.apply(tile, Some(p))
//                     } else {
//                         new_state.game.apply(tile, None)
//                     };
...
//             Action::Pass => {
//                 let mut new_state = (*self).clone();
//                 new_state.game.eliminate_player();

//                 if new_state.game.is_terminal() {
